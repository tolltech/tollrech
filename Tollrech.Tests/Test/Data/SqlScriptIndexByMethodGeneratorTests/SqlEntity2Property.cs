...
namespace Tollrech.Tests.Test.Data.SqlScriptGeneratorTests
{
    ...
    public class MyHadnler : EntityHandlerBase<OnlinePaymentSessionDbo>
    {
        ...
        public Task<OnlinePaymentSessionDbo[]> SelectAsync{caret}(DateTime exclusiveFromDate, PaymentState state, OnlinePaymentAgent[] agents)
        {
            return GetTable()
        ...
        public async Task<(PaymentState PaymentState, int Count)[]> CountByPaymentStateAsync(OnlinePaymentAgent paymentAgent, DateTime exclusiveFromDate)
        {

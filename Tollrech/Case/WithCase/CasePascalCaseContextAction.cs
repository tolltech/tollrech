...
namespace Tollrech.Case.WithCase
{
	...
	public class CasePascalCaseContextAction : CaseContextActionBase
	{
		public CasePascalCaseContextAction([NotNull] ICSharpContextActionDataProvider provider) : base(provider, InflectorExtensions.Pascalize)
		{
		}
